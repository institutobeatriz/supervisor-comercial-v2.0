 ...
 */
export function normalizeMessage(instanceName, data) {
    try {
        ...
        // Determinar origem
        const origin = key.fromMe ? 'seller' : 'client';
 ...
 */
export function normalizeStatus(instanceName, data) {
    try {
 ...
 */
export function normalizeConnection(instanceName, data) {
    const parsed = z.object({
 ...
 */
function extractBotJid(remoteJid) {
