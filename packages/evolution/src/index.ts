 ...
 */
function getMessageType(message: z.infer<typeof MessageSchema>): NormalizedMessage['type'] {
 ...
 */
function parseFileLength(value: string | number | undefined): number | null {
...
export function normalizeMessage(
  ...
  try {
    ...
    const direction: NormalizedMessage['direction'] = key.fromMe ? 'outbound' : 'inbound';
